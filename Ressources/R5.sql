...
FROM basestation
UNION ALL
SELECT CONCAT ("REPLACE subcell (SUBCELLID, SUBISBACKOFFICE, SUBCELLMODE, SUBBSNAME, SUBCELLALIAS) VALUES ('",SUBCELLID,"','",SUBISBACKOFFICE,"','",SUBCELLMODE,"','",SUBBSNAME,"','",SUBCELLALIAS,"');") 
FROM subcell
UNION ALL
SELECT CONCAT ("REPLACE subcelltrxmap (TRXID, SCMSUBCELLID) VALUES ('",TRXID,"','",SCMSUBCELLID,"');") 
FROM subcelltrxmap
UNION ALL
SELECT CONCAT ("REPLACE transceiver (ID, TRXBSNAMEREF, TRXPORTNUM, TRXCABLEINDEX, TRXHWID) VALUES ('",ID,"','",TRXBSNAMEREF,"','",TRXPORTNUM,"','",TRXCABLEINDEX,"','",TRXHWID,"');") 
FROM transceiver
)I;
